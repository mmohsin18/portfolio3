    ...
    <div className="text-white">
      ...
      <div className=" px-32">
        ...
        <div className="flex items-start justify-between">
            ...
            <div className="w-[30%]">
                <h1 className="flex font-semibold items-center mb-3 justify-center">Sabujbagh Govt. College</h1>
                <div className="flex flex-col gap-3">
                    <h1>Active Member <br /><span className="text-zinc-400">at Sabujbagh Govt College Cultural Club</span></h1>
                </div>
            </div>
            <div className="w-[30%]">
